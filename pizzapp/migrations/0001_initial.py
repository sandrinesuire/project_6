# Generated by Django 2.1.2 on 2019-04-30 14:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inactivity_date', models.DateField(help_text='The date for inactivity declaration.', null=True)),
                ('comment', models.TextField(help_text='The eventual comment.', null=True)),
                ('client', models.ForeignKey(help_text='The client.', on_delete=django.db.models.deletion.CASCADE, to='pizzapp.Client')),
        ...
        migrations.AddField(
            model_name='client',
            name='person',
            field=models.OneToOneField(help_text='The person corresponding to this client.', on_delete=django.db.models.deletion.CASCADE, to='pizzapp.Person'),
        ),
        migrations.AddField(
            model_name='client',
            name='type_addresses',
